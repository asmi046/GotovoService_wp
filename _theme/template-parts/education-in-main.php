            ...
            <div class="education-doctrine d_flex jc_sb m_b_40 f_wrap">
                <div class="education-box brad_12 gradient">
                    ...
                    <ul class="education-list">
                        ...
                        <li>Высокий доход;</li>
                        <li>Бонусы в первые дни работы.</li>
                    </ul>
                </div>
                ...
                <div class="education-box brad_12 gradient">
                    ...
                    <ul class="education-list">
                        <li>Обучение на реальной технике;</li>
                        <li>Профессиональные пособия;</li>
                ...
                <div class="education-box brad_12 gradient">
                    ...
                    <ul class="education-list">
                        <li>Наставник в первые дни работы;</li>
                        <li>Навыки работы с клиентами;</li>
