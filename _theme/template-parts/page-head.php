...
<section class="page_head gradient pos_rel">
    ...
    <?} else {?>
        <img src="<?php echo wp_get_attachment_image_src(carbon_get_term_meta( get_cat_ID( single_cat_title('', 0) ), 'page_head_img'), 'full')[0];?>" alt="<? the_title(); ?>" class="pos_abs page_head_img">
    <?}?>    
